...
export interface ApiComissioComissio extends Struct.CollectionTypeSchema {
  collectionName: 'comissions';
  info: {
    displayName: 'Comissio';
    pluralName: 'comissions';
    singularName: 'comissio';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whoweare: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::comissio.comissio': ApiComissioComissio;
